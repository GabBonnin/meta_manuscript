...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, opacityback=0, opacitybacktitle=0.6, colframe=quarto-callout-note-color-frame, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, rightrule=.15mm, colback=white, titlerule=0mm, bottomtitle=1mm, toptitle=1mm, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, left=2mm, coltitle=black, toprule=.15mm, leftrule=.75mm, breakable]
...
A descriptive analysis revealed substantial heterogeneity across
questions in both response rates and linguistic richness (Table X).
Broad narrative prompts, particularly the problem description and
therapy goals questions, showed low missingness and high median word
counts, indicating that patients readily provided extended
self-generated narratives when asked to reflect holistically on their
difficulties or desired changes. In contrast, questions targeting
specific events, causal attributions, physical symptoms, or affected
life domains often elicited brief or list-like responses, consistent
with their more constrained and confirmatory formats.

\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.2292}}
  >{\centering\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.0938}}
  >{\centering\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.1354}}
  >{\centering\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.1667}}
  >{\centering\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.1458}}
  >{\centering\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.1146}}
  >{\centering\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.1146}}@{}}
...
\item
  Validation Data (N=)
\item
  Inclusion: Patients with at least one non-missing narrative response
  (Q10 or Q12) and available baseline symptom assessments.
\end{itemize}
...
\item
  ...
  \begin{itemize}
  \item
    Concatenation of Q10 + Q12.
  \item
    Concatenation of all answered open-ended responses.
  \end{itemize}
\end{itemize}
...
diagnostic categories and baseline severity.
...
Question-wise modeling (no forced concatenation).
...
\tightlist
\item
  Primary analyses: Descriptive characterization of thematic content and
  narrative patterns within and across questions.
\item
  Secondary analyses: Stratification of themes by diagnostic categories,
  baseline symptom severity, or sociodemographic characteristics.
\end{itemize}
...
treatment outcomes---such as global improvement, clinician-rated change,
and individualized goal attainment---beyond baseline symptom severity
...
\item
  ...
  \begin{itemize}
  \item
    Simple language features (e.g., word count, pronouns, negations).
  \item
    Contextual embeddings derived from pretrained large language models.
  \end{itemize}
\end{itemize}
