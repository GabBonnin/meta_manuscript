...
bdi_erw |>
  ...
  filter(n() > 21) |>
  ungroup() |>
  distinct(patient_chiffre) |>
  pull(patient_chiffre)
...
# es gibt scheinbar fälle, bei denen z.B. LZT 2 zweimal stattgefunden hat, dadurch ergeben sich summenwerte > 27. --> Wie viele Fälle gibt es davon und wie gehe ich damit um?
...
# es betrifft diese Fälle (auch bei BDI, scheinbar über den gesamten Datensatz) --> Plausibilitätscheck, welches Assessment, "das richtige" in der Reihenfolge anhand des Datums.
#  [1] "S281197" "H281139" "R200472" "S260891" "A160698" "B300985"
# [7] "S150380" "N221187" "S190600" "L240293"
# [1] "W210465" 
